   ...
   $( ".cog, .admin-text" ).on( "click", function()
{
    ...
    <body>
        ...
        <div class="page-title top-content">
            <div class="content">
	<div class="admin-panel"><b class="admin-text">Admin settings</b></div>
	<span class="cog octicon octicon-gear"></span>
	<div>
	 <h1><a href="https://dribbble.com/shots/850410" target="_blank">CHOOSE</a></h1>
	<div class="menu">
		<div class="arrow"></div>
			<a href="registerdoctor.php">Register a new doctor<span class="icon octicon octicon-person"></span></a>
			<a href="listofregistereddoctors.php">View a list of the registered doctors<span class="icon octicon octicon-graph"></span></a>
			<a href="deletedoctor.php">Delete a doctor<span class="icon octicon octicon-graph"></span></a>
			<a href="editdoctor.php">Edit the information of an existing doctor <span class="icon octicon octicon-graph"></span></a>
		    <a href="searchdoctor.php">Search for a specific doctor <span class="icon octicon octicon-graph"></span></a>
	</div>
	</div>
	</div>
        </div>
